    ...
    caseStudies: [
      {
        ...
        sketches: [
          "Flat croquis silhouettes, pencil on marker paper — 12 variations, numbered and annotated with seam guesses.",
          "Fold studies directly on the dress form, charcoal on newsprint, capturing how the muslin actually broke versus how I'd drawn it.",
          "Corrections in red ink over the original croquis, marking every place the fabric disagreed with the sketch.",
        ],
        iterations: [
          {
            title: "First pin-up",
      ...
      },
      {
        ...
        sketches: [
          "Full-scale paper block with box-pleat folding tested at the shoulder seam.",
          "Miniature study folds at 1:4 scale to fail fast before committing to full-scale paper.",
        ],
        iterations: [
    ...
    caseStudies: [
      {
        ...
        sketches: [
          "Hand-painted colour wheel, gouache on watercolour paper, with mixing ratios noted in pencil margin.",
          "Digital swatch grid in Illustrator, matched by eye against the physical wheel under consistent daylight.",
        ],
        iterations: [
      ...
      },
      {
        ...
        sketches: [
          "Hand-labelled letterform anatomy on tracing paper over printed specimens.",
          "Thumbnail grid layouts testing four different poster compositions at business-card scale.",
        ],
        iterations: [
    ...
    caseStudies: [
      {
        ...
        sketches: [
          "Days 1–10: tentative, broken lines, heavy pencil pressure.",
          "Days 40–50: single unbroken contour lines, fineliner, noticeably faster and looser.",
          "Days 90–100: line drawings held from memory rather than direct observation.",
        ],
        iterations: [
      ...
      },
      {
        ...
        sketches: [
          "Anatomical proportion studies, 9-head grid, graphite.",
          "Loosened 'house croquis' poses developed for fast garment sketching, marker fills.",
        ],
        iterations: [
    ...
    caseStudies: [
      {
        ...
        sketches: [
          "Dot-grid underlays in pencil, before any colour is placed, showing the pure geometric skeleton.",
          "Colour-fill studies testing the same grid with three different regional palettes.",
        ],
        iterations: [
      ...
      },
      {
        ...
        sketches: [
          "Single-motif studies in gouache, isolated from their grid for the first time.",
          "Repeat-tile testing sheets, marking motif edges that needed adjusting to tile cleanly.",
        ],
        iterations: [
    ...
    caseStudies: [
      {
        ...
        sketches: [
          "Material swatch pages, one per item, with hand-written notes on strength and manipulation.",
          "Combination studies pairing two materials to test structural collaboration — newspaper strengthened with fabric scrap glue-lamination.",
        ],
        iterations: [
      ...
      },
      {
        ...
        sketches: [
          "Diagrammatic notes of the printing table set-up, drawn on site.",
          "Tool sketches — wooden printing blocks, dye trays — annotated with dimensions and use notes.",
        ],
        iterations: [
    ...
    caseStudies: [
      {
        ...
        sketches: [
          "Pressed-specimen pages with watercolour match swatches alongside each.",
          "A seasonal colour-shift chart tracking how five repeat specimens changed hue over eight weeks.",
        ],
        iterations: [
      ...
      },
      {
        ...
        sketches: [
          "Contact-sheet style photo grid, sorted by symmetry type.",
          "Hand-drawn geometric overlays on printed photographs, tracing the underlying symmetry axis of each.",
        ],
        iterations: [
...
export const allCaseStudies = locations.flatMap((location) =>
  location.caseStudies.map((cs) => ({ ...cs, location }))
);

export const getCaseStudy = (slug: string) =>
  allCaseStudies.find((cs) => cs.slug === slug);
